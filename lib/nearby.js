...
fns.getLocationsNearby = (requestData, done) => {
    Joi.validate(requestData.data, validation.locationsNearby, function getlocationsNearbyInner(err, data) {
        ...
        db.findDataNearby('locations', data.long, data.lat, {
                maxDistance: distance / 6371, //TODO: what? why 6371? what if undefined?
                limit: data.limit || 10
            })
            .then(data => {
